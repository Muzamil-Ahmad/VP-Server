...
<h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather=""></i></span></span>Subcategories</h4>
 <a type="button" href="{{url('subcategory/create')}}" class="btn btn-primary pull-right">Add New Subcategory</a>
</div>
<!-- /Title -->
...
//       -->
    ...
    ajax:{
        url: "{{ url('api/subcategories') }}"+"?supplierId="+ JSON.parse(localStorage.getItem('userInfo')).user.id,
        type: 'GET',
        dataType:'JSON',
