...
<div class="container">
   ...
   <div class="hk-pg-header">
      ...
      <a type="button" href="{{url('category/create')}}" class="btn btn-primary pull-right">Add New Category</a>
   </div>
   <!-- /Title -->
   <!-- Row -->
   <div class="row">
...
<script type="text/javascript"> 
                ...
                function fetchCategories(){
                    ...
                    $('#categoryTbl1').DataTable({
                        ajax: {
                            url: "{{ url('/api/categories') }}"+"?supplierId="+ JSON.parse(localStorage.getItem('userInfo')).user.id,
                            type: 'GET',
                            dataType: 'JSON',
