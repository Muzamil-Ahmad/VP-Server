...
Route::group([
   ...
   Route::get('feedback', 'FeedbackController@get');
    ...
    //assignment
    Route::get('role/assignment', 'RolesController@getAssignment');
    Route::post('role/assignment', 'RolesController@createAssignment');
    Route::get('role/assignment/{id}', 'RolesController@editAssignment');
    //profile
